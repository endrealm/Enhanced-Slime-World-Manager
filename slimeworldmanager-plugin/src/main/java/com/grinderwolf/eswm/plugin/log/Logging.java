package com.grinderwolf.eswm.plugin.log;
...
public class Logging {
    ...
    public static final String COMMAND_PREFIX = ChatColor.BLUE + ChatColor.BOLD.toString() + "E-SWM " + ChatColor.GRAY + ">> ";
    private static final String CONSOLE_PREFIX = ChatColor.BLUE + "[E-SWM] ";
